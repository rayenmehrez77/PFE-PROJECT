                ...
                <div className="card-body">
                  <div className="row">
                    {/* <div className="col-xl-5 col-xxl-12 col-md-5">
                      <h4 className="fs-20 text-black mb-4 font-w700">
                        Spendings
                      </h4>
                      <div className="row">
                        ...
                        <div className="col-sm-6 mb-4">
                          <div className="bg-gradient1 rounded text-center p-3">
                            <div className="d-inline-block position-relative donut-chart-sale mb-3">
                              ...
                              />
                              <small className="text-white">65%</small>
                            </div>
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <div className="d-flex align-items-end mt-2 pb-3 justify-content-between">
                        <span>Monastir</span>
                        <span className="fs-16 font-w600 text-light">
                          <span className="text-black pe-2">300 membres</span>
                          /1000 membres
                        </span>
                      </div>
                      <div className="progress default-progress mt-4">
                      ...
                      <div className="d-flex align-items-end mt-2 justify-content-between">
                        <span>Sousse</span>
                        <span className="fs-16 font-w600 text-light">
                          <span className="text-black pe-2">400 membres</span>
                          /1000 membres
                        </span>
                      </div>
                    </div>
